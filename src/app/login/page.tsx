      ...
      <div className="relative z-10 w-full max-w-md flex flex-col p-6 sm:p-12 justify-center bg-white/50 backdrop-blur-xl border border-white/60 rounded-[2.5rem] shadow-[0_8px_40px_rgba(0,0,0,0.05)] animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="w-full">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-3 font-serif drop-shadow-sm">Welcome Back</h1>
            <p className="text-gray-600 font-medium text-sm sm:text-base">Sekali Tap, Rute & Tiket Beres.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={async (e) => { 
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-[0.15em]">Password</label>
                <a href="#" className="text-xs font-bold text-greenDark hover:text-[#20401b] transition-colors">Forgot password?</a>
              </div>
              <input 
                type="password" 
                placeholder="••••••••" 
          ...
          <p className="text-center mt-8 text-sm text-gray-500 font-medium">
            Don&apos;t have an account? <Link href="/signup" className="text-greenDark font-bold hover:text-[#20401b] transition-colors underline-offset-4 hover:underline">Sign Up</Link>
          </p>
